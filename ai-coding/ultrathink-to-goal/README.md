...
- **状态**:当前 44 页 deck 已完成 tonight 版内容 refactor, Claude Code timeline 已更新到 2026-05-11 UTC
...
- `research/` — 准备过程中的 deep research + fact-check 记录
...
- `screenshots/` — 引用源截图(tweet 卡片、blog 截屏、YouTube thumbnail 等)
- [`scripts/README.md`](./scripts/README.md) — 截图工作流,含批量截图 + YouTube 视频帧抽取
