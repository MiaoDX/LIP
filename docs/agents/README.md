...
- `standalone-decks.md`: source ownership, path, template, publishing, punctuation, and visual verification rules for standalone HTML decks.

Keep root agent files for startup rules, local hazards, and command pointers. Put longer agent-only procedures in this directory.
