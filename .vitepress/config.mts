...
export default defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      lang: 'en',
      title: 'LIP — Learn In Public',
      description: "MiaoDX's Learn in Public: A public evolution log of AI Coding and OpenClaw",
      link: '/en/',
      themeConfig: {
        authorBio: {
          name: 'MiaoDX × AI Agents',
          desc: 'Robotics Engineer & OPC Practitioner — One Person, plus multi Claws. Writes bugs for robots by day, builds more with AI Agents by night.',
          links: [
            { text: 'GitHub ↗', url: 'https://github.com/MiaoDX' },
            { text: 'Blog ↗', url: 'https://miaodx.com' },
            { text: 'All Stories →', url: 'https://miaodx.com/LIP/en/' }
          ]
        },
        nav: [
          { text: 'Home', link: '/en/' },
          ...
          { text: 'Sharing', link: '/en/share/' },
          { text: 'Personal Site', link: 'https://miaodx.com', target: '_blank' }
        ],
        sidebar: [
          {
            text: 'Getting Started',
            items: [
              { text: 'Home (Overview)', link: '/en/' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Deployment Guide (Docker + Dual Platform)', link: '/en/resources/deployment-guide-v2' },
              { text: '📖 Case Stories', link: '/en/stories/' },
            ],
          },
          {
            text: '🧠 Lessons',
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Gateway Resilience Architecture', link: '/en/drafts/lessons/gateway-resilience' },
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'Sharing Index', link: '/en/share/' },
              ...
              { text: 'Low-Cost Multi-Agent Deployment', link: '/en/share/lowcost-multiplatform-multiagent-deploy' },
