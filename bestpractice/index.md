...
| 文章 | 日期 | 主题 |
|------|------|------|
| [Multi-Agent Research System 深度分析](/LIP/bestpractice/anthropic-multi-agent-research) | 2025-06 | Orchestrator-Worker 架构、并行化、Token 经济学 |
| [Context Engineering 深度分析](/LIP/bestpractice/anthropic-context-engineering) | 2025-09 | Context Rot、Attention Budget、最小高信号 Token 集 |
