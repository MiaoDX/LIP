...
> [!NOTE]
> 本栏目是 2026 上半年 OpenClaw 多实例实验的归档，已停止更新。当前主线见 [AI Coding × 机器人](/ai-coding/)。

聚焦部署、配置、最佳实践、实战案例。目标是让个人或小团队低成本搭建可持续运行的 Agent 体系。

## 案例故事

| 文章 | 日期 | 简介 |
|------|------|------|
| [双 Agent 启动日志](/stories/2026-03-dual-agent-start) | 2026-03 | WLB + GSD 双 Agent 从 0 到 1 的完整踩坑 |
...
| [API Key 安全事故复盘](/stories/api-key-exposure-incident) | 2026-03 | 7分钟安全事故，Agent自律机制检验 |
| [双 Agent 协作协议](/stories/dual-agent-collaboration-protocol) | 2026-03 | 从无限循环到高效分工的协作演进 |
| [龙虾文明 RPG 沙盒](/stories/lobster-civilization-sandbox) | 2026-03 | 两个 AI Agent 的文明推演实验 |
...
- [经验与规则](/lessons/) — 从事故中提炼的可复用模式
- [资源与配置](/resources/) — 部署指南和配置模板
